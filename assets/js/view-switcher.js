...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const gridViewBtn = document.querySelector('.switch-view[data-view="grid"]');
  const listViewBtn = document.querySelector('.switch-view[data-view="list"]');
  ...
  function switchToGridView() {
    ...
    productItems.forEach((item) => {
      ...
      if (rowWrapper) {
        ...
        if (imageCol && infoCol) {
          const productThumbnail = imageCol.querySelector(".product-thumbnail");
    ...
    productItems.forEach((item) => {
      ...
      if (!item.querySelector(".row")) {
        ...
        if (productThumbnail && productInfo && priceBox) {
          ...
          // Add description div (you can customize this content)
...
window.ViewSwitcher = {
  switchToGrid: function () {
    ...
    document
      .querySelector('.switch-view[data-view="grid"]')
      .dispatchEvent(event);
  },
  switchToList: function () {
    const event = new Event("click");
    document
      .querySelector('.switch-view[data-view="list"]')
      .dispatchEvent(event);
  },
